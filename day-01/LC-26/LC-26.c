...
int removeDuplicates(int *nums, int numsSize) {
  // Marca a posicao do proximo elemento unico e tambem conta quantos existem. 
  // Começa em 1, pois nums[0] e sempre mantido
  int slow_ptr = 1;

  // Percorre o array a partir do segundo elemento para encontrar novos valores
  for (int i = 1; i < numsSize; i++) {
    // Compara o elemento atual com o ultimo unico registrado
